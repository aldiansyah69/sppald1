...
<p>&nbsp;</p>
  ...
  // memanggil file koneksi.php untuk membuat koneksi
    ...
    $query = "SELECT * FROM tb_pembayaran, tb_siswa, tb_spp, tb_petugas, tb_kelas WHERE pembayaran.nisn=siswa.nisn AND siswa.id_spp=spp.id_spp AND pembayaran.id_petugas=petugas.id_petugas AND siswa.id_kelas=kelas.id_kelas AND (pembayaran.tgl_bayar between '$daritanggal' AND '$sampaitanggal')";
